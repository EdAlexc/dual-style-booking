      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="grid gap-10 md:grid-cols-2">
          <p className="text-md leading-relaxed text-foreground/85">
            ...
            <br></br> He collaborates with his clients to individually tailor and design
          ...
          <p className="text-md leading-relaxed text-foreground/85">
            <br></br> With over 15 years of experience, he has worked as an artist for Laura Mercier 
            ...
            <br></br> He specializes in creative makeup for stage, nightlife, and events working 
