...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Studio MUA — Editorial Makeup Artistry" },
      { property: "og:description", content: "Editorial and bridal makeup artistry. Two signatures: Glam and Bold." },
